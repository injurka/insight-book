...
const apiRoutes = {
  ...
  '/api/dictionary/prompts': { OPTIONS: corsOk, GET: apiWrapper(authWrapper(handleGetCustomPrompts)), POST: apiWrapper(authWrapper(handleCreateCustomPrompt)) },
  '/api/dictionary/prompts/:id': { OPTIONS: corsOk, PATCH: apiWrapper(authWrapper(handleUpdateCustomPrompt)), DELETE: apiWrapper(authWrapper(handleDeleteCustomPrompt)) },
  '/api/dictionary/chat': { OPTIONS: corsOk, POST: apiWrapper(authWrapper(handleDictionaryChat)) },
