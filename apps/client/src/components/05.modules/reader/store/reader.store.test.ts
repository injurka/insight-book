import type { PagePayload } from '~/shared/types/models'
...
vi.mock('~/components/05.modules/library/store/library.store', () => ({
  useLibraryStore: () => mocks.libraryStore,
}))

vi.mock('~/shared/store/analysis/analysis.store', () => ({
