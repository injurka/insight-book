...
const mockDict: Record<string, any> = {
  El: { tr: '[эль]', trans: 'Определенный артикль', pos: 'Артикль', posClass: 'pos-default', rule: 'Мужской род, единственное число.' },
  secreto: { tr: '[секрето]', trans: 'Секрет; тайна', pos: 'Существительное', posClass: 'pos-noun', rule: 'Мужской род. Происходит от лат. secretus.' },
  de: { tr: '[де]', trans: 'Из; от; о', pos: 'Предлог', posClass: 'pos-default', rule: 'Указывает на принадлежность или происхождение.' },
  la: { tr: '[ла]', trans: 'Определенный артикль', pos: 'Артикль', posClass: 'pos-default', rule: 'Женский род, единственное число.' },
  felicidad: { tr: '[фелисидад]', trans: 'Счастье; радость', pos: 'Существительное', posClass: 'pos-noun', rule: 'Женский род, абстрактное понятие.' },
  no: { tr: '[но]', trans: 'Нет; не', pos: 'Частица', posClass: 'pos-default', rule: 'Отрицательная частица.' },
  es: { tr: '[эс]', trans: 'Является; есть', pos: 'Глагол', posClass: 'pos-verb', rule: 'Форма глагола ser (быть) в 3-м лице ед.ч.' },
  hacer: { tr: '[асер]', trans: 'Делать; создавать', pos: 'Глагол', posClass: 'pos-verb', rule: 'Инфинитив. Нерегулярный глагол.' },
  siempre: { tr: '[сьемпре]', trans: 'Всегда; постоянно', pos: 'Наречие', posClass: 'pos-adj', rule: 'Наречие времени.' },
  lo: { tr: '[ло]', trans: 'То; это', pos: 'Местоимение', posClass: 'pos-pronoun', rule: 'Нейтральное местоимение.' },
  que: { tr: '[ке]', trans: 'Что; который', pos: 'Союз', posClass: 'pos-default', rule: 'Соединительный союз или относительное местоимение.' },
  se: { tr: '[се]', trans: 'Себя; себе', pos: 'Местоимение', posClass: 'pos-pronoun', rule: 'Возвратное местоимение 3-го лица.' },
  quiere: { tr: '[кьере]', trans: 'Хочет; желает', pos: 'Глагол', posClass: 'pos-verb', rule: 'Форма глагола querer (хотеть) в 3-м лице ед.ч.' },
}
